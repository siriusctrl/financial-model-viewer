...
Use `format: financial-model-workbook-map@0.2` for every map; pre-0.2 maps are rejected. The `row` mapping mode remains available inside 0.2 for genuine grids. Provide:
